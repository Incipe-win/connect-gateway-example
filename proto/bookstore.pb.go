...
const file_bookstore_proto_rawDesc = "" +
	"\n" +
	"\x0fbookstore.proto\x12\tbookstore\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/api/annotations.proto\"A\n" +
	"\x05Shelf\x12\x0e\n" +
	...
	"\x05shelf\x18\x01 \x01(\x03R\x05shelf\x12\x12\n" +
	"\x04book\x18\x02 \x01(\x03R\x04book2\xbd\x06\n" +
	"\tBookStore\x12^\n" +
	"\vListShelves\x12\x16.google.protobuf.Empty\x1a\x1e.bookstore.ListShelvesResponse\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/api/v1/shelves\x12^\n" +
	"\vCreateShelf\x12\x1d.bookstore.CreateShelfRequest\x1a\x10.bookstore.Shelf\"\x1e\x82\xd3\xe4\x93\x02\x18:\x05shelf\"\x0f/api/v1/shelves\x12Y\n" +
	"\bGetShelf\x12\x1a.bookstore.GetShelfRequest\x1a\x10.bookstore.Shelf\"\x1f\x82\xd3\xe4\x93\x02\x19\x12\x17/api/v1/shelves/{shelf}\x12e\n" +
	"\vDeleteShelf\x12\x1d.bookstore.DeleteShelfRequest\x1a\x16.google.protobuf.Empty\"\x1f\x82\xd3\xe4\x93\x02\x19*\x17/api/v1/shelves/{shelf}\x12m\n" +
	"\tListBooks\x12\x1b.bookstore.ListBooksRequest\x1a\x1c.bookstore.ListBooksResponse\"%\x82\xd3\xe4\x93\x02\x1f\x12\x1d/api/v1/shelves/{shelf}/books\x12h\n" +
	"\n" +
	"CreateBook\x12\x1c.bookstore.CreateBookRequest\x1a\x0f.bookstore.Book\"+\x82\xd3\xe4\x93\x02%:\x04book\"\x1d/api/v1/shelves/{shelf}/books\x12c\n" +
	"\aGetBook\x12\x19.bookstore.GetBookRequest\x1a\x0f.bookstore.Book\",\x82\xd3\xe4\x93\x02&\x12$/api/v1/shelves/{shelf}/books/{book}\x12p\n" +
	"\n" +
	"DeleteBook\x12\x1c.bookstore.DeleteBookRequest\x1a\x16.google.protobuf.Empty\",\x82\xd3\xe4\x93\x02&*$/api/v1/shelves/{shelf}/books/{book}B|\n" +
	"\rcom.bookstoreB\x0eBookstoreProtoP\x01Z\x17bookstore_enhance/proto\xa2\x02\x03BXX\xaa\x02\tBookstore\xca\x02\tBookstore\xe2\x02\x15Bookstore\\GPBMetadata\xea\x02\tBookstoreb\x06proto3"
